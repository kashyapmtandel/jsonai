    ...
    <div className="legal-page">
      ...
      <div className="legal-content">
        <section>
          <h2>Our Mission</h2>
          <p>
            JSON Tools was built with a simple mission: to provide developers with the fastest, most reliable, 
        ...
        <section>
          ...
          <p>
            We built JSON Tools to solve this. Our entire suite of tools is 100% client-side. This means your data never 
